...
class Dinas_model extends CI_Model
{
    ...
    {
        return $this->db->get('tb_dinas')->result_array();
    }

    public function insertDinas($data)
    {
        return $this->db->insert('tb_dinas', $data);
    }

    public function getByDinas($data)
    {
        return $this->db->get_where('tb_dinas', ['id_dinas' => $data])->row_array();
    }

    public function updateDinas($data, $param)
    {
        return $this->db->update('tb_dinas', $data, ['id_dinas' => $param]);
    }

    public function deleteDinas($param)
    {
        return $this->db->delete('tb_dinas', ['id_dinas' => $param]);
    }
