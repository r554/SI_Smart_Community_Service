	        ...
	        <div class="row page-titles mx-0">
	            ...
	            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
	                <ol class="breadcrumb">
	                    ...
	                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Edit Data Dinas</a></li>
	                </ol>
	            </div>
	        </div>
	                                ...
	                                <div class="row">
	                                    <div class="col-xl-6">
	                                        <div class="form-group row">
	                                            ...
	                                            <div class="col-lg-6">
	                                                <input type="text" class="form-control" id="dinas" name="dinas" placeholder="Nama Dinas" maxlength="50" value="<?= $dinas_edit['nama_dinas']; ?>" required>
	                                        ...
	                                        <div class="form-group row">
	                                            ...
	                                            <div class="col-lg-6">
	                                                <input type="text" class="form-control" id="alamat_dinas" name="alamat_dinas" placeholder="Alamat Dinas" value="<?= $dinas_edit['alamat_dinas']; ?>" required>
	                                    ...
	                                    <div class="col-xl-6">
	                                        ...
	                                        <div class=" form-group row">
	                                            <div class="col-lg-8 ml-auto">
	                                                <button type="submit" class="btn btn-primary btn-md" name="edit_user" value="true">Simpan Data Dinas</button>
	                                            </div>
	                                        </div>
	                                    </div>
	                                </div>
