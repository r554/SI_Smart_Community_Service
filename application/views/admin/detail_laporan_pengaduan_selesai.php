  		...
  		<div class="container-fluid">
  			<div class="row page-titles mx-0">
  				<div class="col-sm-6 p-md-0">
  					<div class="welcome-text">
  						<h4>Detail Data Pengaduan Selesai</h4>
  				...
  				<div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
  					<ol class="breadcrumb">
  						...
  						<li class="breadcrumb-item active"><a href="javascript:void(0)">Detail Pengaduan Selesai</a></li>
  					</ol>
  				</div>
  			</div>
  							...
  							<div class="basic-form">
  								<form>
  									...
  									<div class="form-group row">
  										...
  										<div class="col-sm-9">
  											<a href="javascript:void()" class="badge badge-rounded badge-success">Selesai</a>
  										</div>
  									</div>
  			...
  			<div class="row mt-3">
  				<div class="col-lg-12">
  					<div class="card">
  						<div class="card-header">
  							<h5 class="card-title">Bukti Lampiran Laporan Pengaduan Selesai</h5>
  						</div>
  						<div class="card-body">
  							<div class="form-group row">
  								<label class="col-sm-3 col-form-label">Tanggal Selesai</label>
  								<div class="col-sm-9">
  									<input type="text" class="form-control" value="<?= $detail_laporan2['tanggal_selesai']; ?>" readonly>
  								</div>
  							</div>
  							<div class="form-group row float-right">
  								<img src="<?= base_url() . 'assets/img/' . $detail_laporan2['foto_laporan_selesai']; ?>" alt="" class="img-fluid">
  							</div>
  						</div>
