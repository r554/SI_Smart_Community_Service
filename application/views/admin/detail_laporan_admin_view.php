  	    ...
  	    <div class="container-fluid">
  	        <div class="row page-titles mx-0">
  	            ...
  	            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
  	                <ol class="breadcrumb">
  	                    ...
  	                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Detail Pengaduan</a></li>
  	                </ol>
  	            </div>
  	        </div>
  	                                ...
  	                                <div class="form-group row">
  	                                    ...
  	                                    <div class="col-sm-9">
  	                                        <input type="text" class="form-control"
  	                                            value="<?= $detail_laporan['judul']; ?>" readonly>
  	                                    </div>
  	                                </div>
  	                                <div class="form-group row">
  	                                    ...
  	                                    <div class="col-sm-9">
  	                                        <input type="text" class="form-control"
  	                                            value="<?= $detail_laporan['username']; ?>" readonly>
  	                                    </div>
  	                                </div>
  	                                <div class="form-group row">
  	                                    ...
  	                                    <div class="col-sm-9">
  	                                        <input type="text" class="form-control"
  	                                            value="<?= $detail_laporan['tanggal']; ?>" readonly>
  	                                    </div>
  	                                </div>
  	                                <div class="form-group row">
  	                                    ...
  	                                    <div class="col-sm-9">
  	                                        <input type="text" class="form-control"
  	                                            value="<?= $detail_laporan['deskripsi']; ?>" readonly>
  	                                    </div>
  	                                </div>
  	                                <div class="form-group row">
  	                                    ...
  	                                    <div class="col-sm-9">
  	                                        <input type="text" class="form-control"
  	                                            value="<?= $detail_laporan['alamat']; ?>" readonly>
  	                                    </div>
  	                                </div>
  	                                <div class="form-group row">
  	                                    ...
  	                                    <div class="col-sm-9">
  	                                        <input type="text" class="form-control"
  	                                            value="<?= $detail_laporan['lat']; ?>" readonly>
  	                                    </div>
  	                                </div>
  	                                <div class="form-group row">
  	                                    ...
  	                                    <div class="col-sm-9">
  	                                        <input type="text" class="form-control"
  	                                            value="<?= $detail_laporan['lng']; ?>" readonly>
  	                                    </div>
  	                                </div>
  	                                <div class="form-group row">
  	                                    <div class="col-sm-10 text-center">
  	                                        ...
  	                                        <button type="button" class="btn btn-info btn-md" data-toggle="modal"
  	                                            data-target="#exampleModalCenter">Terima Laporan & Teruskan Pada
  	                                            Dinas</button>
  	                                        <button type="button" class="btn btn-danger btn-md ml-4" data-toggle="modal"
  	                                            data-target="#TolakPengaduan">Tolak Pengaduan</button>
  	                                        <!-- <a href="<?= base_url('Admin/terima_pengaduan/') . $detail_laporan['id_laporan'] . '/' . $user['telepon']  ?>"><button type="button" class="btn btn-info btn-md">Terima Laporan & Teruskan Pada Dinas</button></a> -->
  	                                            ...
  	                                            <div class="modal-dialog modal-dialog-centered" role="document">
  	                                                <div class="modal-content">
  	                                                    ...
  	                                                    <div class="modal-body">
  	                                                        <p>Pastikan Anda Sudah Memvalidasi Laporan Pengaduan Sebelum
  	                                                            Meneruskan Pada Dinas.</p>
  	                                                    </div>
  	                                                    <div class="modal-footer">
  	                                                        <button type="button" class="btn btn-danger light"
  	                                                            data-dismiss="modal">Tutup</button>
  	                                                        <a
  	                                                            href="<?= base_url('Admin/terima_pengaduan/') . $detail_laporan['id_laporan'] . '/' . $user['telepon']  ?>"><button
  	                                                                type="button"
  	                                                                class="btn btn-primary">Lanjutkan</button></a>
  	                                                    </div>
  	                                                </div>
  	                                            </div>
  	                                        </div>
  	                                        ...
  	                                        <div class="modal fade" id="TolakPengaduan">
  	                                            <div class="modal-dialog modal-dialog-centered" role="document">
  	                                                <div class="modal-content">
  	                                                    ...
  	                                                    <div class="modal-body">
  	                                                        <p>Pastikan Anda Sudah Memvalidasi Laporan Pengaduan Sebelum
  	                                                            Pengaduan Dibatalkan.</p>
  	                                                    </div>
  	                                                    <div class="modal-footer">
  	                                                        <button type="button" class="btn btn-danger light"
  	                                                            data-dismiss="modal">Tutup</button>
  	                                                        <a
  	                                                            href="<?= base_url('Admin/tolak_pengaduan/') . $detail_laporan['id_laporan'] . '/' . $user['telepon'] ?>"><button
  	                                                                type="button"
  	                                                                class="btn btn-primary">Lanjutkan</button></a>
  	                                                    </div>
  	                                                </div>
  	        ...
  	        <div class="row">
  	            <div class="col-lg-12 text-center">
  	                <iframe
  	                    src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15797.715304619995!2d113.72005644072267!3d-8.159477099999993!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xf6c4437632474338!2sState%20Polytechnic%20of%20Jember!5e0!3m2!1sen!2sid!4v1623865800130!5m2!1sen!2sid"
