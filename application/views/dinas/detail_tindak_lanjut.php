  			...
  			<div class="row page-titles mx-0">
  				<div class="col-sm-6 p-md-0">
  					<div class="welcome-text">
  						<h4>Detail Data Pengaduan Diproses</h4>
  				...
  				<div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
  					<ol class="breadcrumb">
  						...
  						<li class="breadcrumb-item active"><a href="javascript:void(0)">Detail Pengaduan Diproses</a></li>
  					</ol>
  				</div>
  			</div>
  							...
  							<div class="basic-form">
  								...
  								<div class="form-group row">
  									<div class="col-sm-10 text-center">
  										<button type="button" class="btn btn-primary btn-md ml-4" data-toggle="modal" data-target="#TolakPengaduan">Pengaduan Selesai</button>
  									</div>
  								</div>
  								<div class="form-group row">
  									<div class="col-sm-10 text-center">
  									...
  									<div class="col-sm-10 text-center">
  										...
  										<div class="modal fade" id="TolakPengaduan">
  											<div class="modal-dialog" role="document">
  												<form action="<?= base_url('Admin/tambah_bukti_selesai') ?>" method="POST" enctype="multipart/form-data">
  													<div class="modal-content">
  														<div class="modal-header">
  														...
  														<div class="modal-body">
  															<b><label>Silahkan Upload Foto Bukti Laporan Selesai, Foto bisa berupa hasil dari perbaikan (pengaduan)</label></b>
  															...
  															<div class="md-form mb-1">
  																<label data-error="wrong" data-success="right" for="form2">Lampiran Foto</label>
  																<input type="file" name="foto_laporan_selesai" id="form2" class="form-control validate">
  															</div>
  														</div>
  														<div class="modal-footer">
  															<button type="button" class="btn btn-danger light" data-dismiss="modal">Tutup</button>
  															<!-- <a href="<?= base_url('Admin/tolak_pengaduan/') . $detail_laporan['id_laporan'] . '/' . $user['telepon'] ?>"><button type="button" class="btn btn-primary">Kirim</button></a> -->
