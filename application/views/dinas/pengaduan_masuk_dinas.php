  				...
  				<div class="col-12">
  					<div class="card">
  						<div class="card-header">
  							<h4 class="card-title">Semua Data Pengaduan Masuk</h4>
  						</div>
  						<div class="card-body">
  											...
  											<tr>
  												...
  												<td>
  													...
  													<?php } elseif ($laporan['status'] == '3') { ?>
  														<span class="badge badge-warning">Valid</span>
  												...
  												<td>
  													<div class="d-flex">
  														<a href="<?= base_url('Admin/Detail_Pengaduan_Masuk_Dinas/' . $laporan['id_laporan']) ?>" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-eye"></i></a>
  													</div>
  												</td>
  											</tr>
  										<?php endforeach; ?>
