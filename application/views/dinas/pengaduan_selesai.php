  				...
  				<div class="col-12">
  					<div class="card">
  						<div class="card-header">
  							<h4 class="card-title">Laporan Pengaduan Selesai</h4>
  						</div>
  						<div class="card-body">
  										...
  										<?php
											...
											?>
  											<tr>
  												...
  												<td>
  													<div class="d-flex">
  														<a href="<?= base_url('Admin/Detail_Pengaduan_Selesai_Dinas/' . $laporan['id_laporan']) ?>" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-eye"></i></a>
  													</div>
  												</td>
  											</tr>
  										<?php endforeach; ?>
