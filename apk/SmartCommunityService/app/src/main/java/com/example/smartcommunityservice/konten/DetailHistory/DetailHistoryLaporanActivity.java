package com.example.smartcommunityservice.konten.DetailHistory;
...
import com.example.smartcommunityservice.konten.DetailHistory.DetailHistoryLaporanActivity;
...
public class DetailHistoryLaporanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_history_laporan);
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (responseObject.getString("status").equals("false")) {
                        ...
                        Toast.makeText(DetailHistoryLaporanActivity.this, responseObject.getString("message"), Toast.LENGTH_SHORT).show();
                        return;
                    }
...
//                    tanggalText.setText(tanggalLaporan);
                    ...
                    Glide.with(DetailHistoryLaporanActivity.this).load(imageLaporan).into(laporanImage);
                    ...
                    contentDetail.setVisibility(View.GONE);
                    errorLayout.setVisibility(View.VISIBLE);
                    Toast.makeText(DetailHistoryLaporanActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(DetailHistoryLaporanActivity.this, message, Toast.LENGTH_SHORT).show();
    ...
    public void onBackPressed() {
        ...
        if (intentFrom.equals("LAPORAN")) {
            Intent toHomeUser = new Intent(DetailHistoryLaporanActivity.this, TabMenunggu.class);
            toHomeUser.putExtra("GOTO_FRAGMENT", "Riwayat");
            startActivity(toHomeUser);
            finish();
        } else {
            Intent toHomeUser = new Intent(DetailHistoryLaporanActivity.this, HomeActivity.class);
